...
import { useAuth0 } from "@auth0/auth0-react"; import { Button } from '../styles/Button';
;
    ...
    <Nav>
      <div className={menuIcon ? 'navbar active' : 'navbar'}>
        <ul className='navbar-lists'>
          ...
          <li>
            <Link className='navbar-link cart-trolley--link' to='/cart'>
        ...
        <div className='mobile-navbar-btn'>
          <CgMenu name='menu_outline' className='mobile-nav-icon'
